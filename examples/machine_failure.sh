...
# 2 RPCs per site): a1-a3 site A validators, a4 site A hot spare.
#
# A failure is handled on two independent axes:
#
#   1. hardware:  ./fleet down 1   hard-kills a1 and records the cordon.
...
#
#   2. weight:    ONE seesaw promotes the spare a4 to the validator tier and
#                 drops a1 to dead. One invocation = one converge with raises
...
# Recovery once a1's hardware is fixed:
