...
- `l1 destroy` disables main validators first and management validators last. It verifies the funding key controls deactivation and receives remaining balances before submitting anything. It is resumable after partial failure and retains generated deployment state as an audit record.
